...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("화면 터치시 프리팹을 소환할 수 있습니다.")]
        private bool m_SpawnOnTouch = false;
        ...
        {
            if (!m_SpawnOnTouch) return false;
            ...
            newObject.GetComponent<XRGrabInteractable>().trackScale = false;
